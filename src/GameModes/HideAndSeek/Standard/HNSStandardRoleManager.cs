...
public class HNSStandardRoleManager : Roles.Managers.RoleManager
{
    private static readonly StandardLogger log = LoggerFactory.GetLogger<StandardLogger>(typeof(HNSStandardRoleManager));
