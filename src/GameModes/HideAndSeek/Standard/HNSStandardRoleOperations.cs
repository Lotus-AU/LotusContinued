...
public class HNSStandardRoleOperations : RoleOperations
{
    private static readonly StandardLogger log = LoggerFactory.GetLogger<StandardLogger>(typeof(HNSStandardRoleOperations));
    public GameMode ParentGameMode { get; }

    public HNSStandardRoleOperations(GameMode parentGamemode)
    {
