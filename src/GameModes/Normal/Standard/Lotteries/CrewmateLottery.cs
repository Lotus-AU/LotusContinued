...
{
    public CrewmateLottery() : base(NormalStandardRoles.Instance.Static.Crewmate)
    {
        NormalStandardRoles.Instance.AllRoles.Where(r => r.Faction is Crewmates && !r.RoleFlags.HasFlag(RoleFlag.IsSubrole)).ForEach(r => AddRole(r));
    }
