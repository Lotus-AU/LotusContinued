...
using Lotus.Roles.RoleGroups.Extra.April;
...
public class NormalStandardRoles : RoleHolder
{
    ...
    public static NormalStandardRoles Instance = null!;

    public NormalStandardRoles()
    {
        Instance = this;
    ...
    public static void AddRole(CustomRole role)
    {
        ...
        role.Solidify();
        NormalStandardGameMode.Instance.RoleManager.RegisterRole(role);
    }
    ...
    public override void AddAddonRole(CustomRole addonRole)
    {
        ...
        addonRole.Solidify();
        NormalStandardGameMode.Instance.RoleManager.RegisterRole(addonRole);
    }
    ...
    public class StaticRoles
    {
        ...
        public Child Child = new(); // April Fools Role
    ...
    public class Modifiers
    {
        ...
        public Drunk Drunk = new(); // April Fools Role
        public Flash Flash = new();
        public Guesser Guesser = new();
        public LastResort LastResort = new();
        public Lagger Lagger = new(); // April Fools Role
        ...
        public Slowpoke Slowpoke = new(); // April Fools Role
        public Sneezer Sneezer = new(); // April Fools Role
