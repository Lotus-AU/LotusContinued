...
public class NormalStandardRoleManager : Roles.Managers.RoleManager
{
    private static readonly StandardLogger log = LoggerFactory.GetLogger<StandardLogger>(typeof(NormalStandardRoleManager));
