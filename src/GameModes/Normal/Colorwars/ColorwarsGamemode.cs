...
using Lotus.GameModes.Normal.Colorwars.Conditions;
using Lotus.GameModes.Normal.Colorwars.Distributions;
using Lotus.Options;
...
public class ColorwarsGamemode : GameMode
{
    ...
    public override string Description { get; set; } = GamemodeTranslations.Colorwars.GamemodeDescription;
